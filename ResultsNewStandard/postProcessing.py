...
parallelisms = list(range(8, 31, 2))
...
MSD = pd.read_csv("floating_point/MSD.csv")
MinSD = pd.read_csv("floating_point/MinSD.csv")
ASD = pd.read_csv("floating_point/ASD.csv")
...
MSD_n = pd.read_csv("fixed_point_nearest/MSD_nearest.csv")
MinSD_n = pd.read_csv("fixed_point_nearest/MinSD_nearest.csv")
ASD_n = pd.read_csv("fixed_point_nearest/ASD_nearest.csv")
...
MSD_ne = pd.read_csv("fixed_point_nearest_even/MSD_nearest_even.csv")
MinSD_ne = pd.read_csv("fixed_point_nearest_even/MinSD_nearest_even.csv")
ASD_ne = pd.read_csv("fixed_point_nearest_even/ASD_nearest_even.csv")
...
MSD_t = pd.read_csv("fixed_point_truncation/MSD_truncation.csv")
MinSD_t = pd.read_csv("fixed_point_truncation/MinSD_truncation.csv")
ASD_t = pd.read_csv("fixed_point_truncation/ASD_truncation.csv")
...
try:
    f_emulator = open("files/simulated_n_10/teleport.txt", "r")
except:
    print("It is not possible to open the files/simulated/teleport.txt file\n")
    sys.exit(1)
...
for line in lines:
     val = line[:-1].split(" ")
     if len(val) == 2:
        real = float(val[0])/2**(8)
        img = float(val[1][:-1])/2**(8)
        z = complex(real, img)
...
try:
    f_emulator = open("files/simulated_ne_10/teleport.txt", "r")
except:
...
#verify the results fixed nearest
try:
    f_emulator = open("files/simulated_t_10/teleport.txt", "r")
except:
...
plt.bar(br3, probabilityDensity_ne, color ='gold', width = barWidth,  label =r'\textit{10 bits nearest even}')
plt.bar(br4, probabilityDensity_n, color ='forestgreen', width = barWidth,  label =r'\textit{10 bits nearest}')
plt.bar(br5, probabilityDensity_t, color ='royalblue', width = barWidth,  label =r'\textit{10 bits truncation}')

plt.xticks([r + 2*barWidth for r in range(len(probabilityDensityfloat))],label)
...
plt.plot(list(QiskitTime['Unnamed: 0']),list(QiskitTime['0']), color='tab:blue', linewidth=4,label=r'\textit{State Vector Simulator}')
...
plt.xlabel(r'\textbf{Number of gates}', fontsize=20)
...
i = 0 
plt.plot(HF['Unnamed: 0'], HF['0'], color='red', linewidth=2,label=r'\textit{Emulator}')
for parallelism in range(18, 32, 2):
    plt.plot(HF_n['Unnamed: 0'], HF_n[format(parallelism)], color=listaCol[i], linewidth=2,label=r'\textit{'+format(parallelism)+  'bits}') 
    i += 1
plt.axhline(y = 0.95, color = 'r', linewidth=4,  linestyle = '--')     
plt.fill_between(HF_n['Unnamed: 0'], 0, 0.95, alpha=0.2, color='r')  
...
i = 0 
plt.plot(MSD['Unnamed: 0'], MSD['0'], color='red', linewidth=2,label=r'\textit{Emulator}')
for parallelism in parallelisms:
    plt.plot(MSD_n['Unnamed: 0'], MSD_n[format(parallelism)], color=listaCol[i], linewidth=2,label=r'\textit{'+format(parallelism)+  'bits}')    
    i += 1
plt.axhline(y = 0.05, color = 'r', linewidth=4,  linestyle = '--')   
plt.fill_between(MSD_n['Unnamed: 0'],0.05, 1, alpha=0.2, color='r')     
plt.ylim([-0.05, 1])   
plt.xlim([10, 187112]) 
plt.xscale("log")    
plt.title(r'\textbf{Maximum sphere distance}',fontsize=20)
plt.xlabel(r'\textbf{Number of gates}', fontsize=20)
plt.ylabel(r'\textbf{Maximum sphere distance}', fontsize=20)
leg = plt.legend(loc='upper right', frameon=True, fontsize=15)
leg.get_frame().set_facecolor('white')
plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
plt.savefig("MSD_nearest.eps", format='eps', bbox_inches='tight')
plt.savefig("MSD_nearest.png", format='png', bbox_inches='tight')
plt.savefig("MSD_nearest.pdf", format='pdf', bbox_inches='tight')
plt.close()  
...
leg.get_frame().set_facecolor('white')
plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
plt.savefig("MSD_nearest_less.eps", format='eps', bbox_inches='tight')
plt.savefig("MSD_nearest_less.png", format='png', bbox_inches='tight')
plt.savefig("MSD_nearest_less.pdf", format='pdf', bbox_inches='tight')
plt.close()  



i = 0 
plt.plot(MinSD['Unnamed: 0'], MinSD['0'], color='red', linewidth=2,label=r'\textit{Emulator}')
for parallelism in parallelisms:
    plt.plot(MinSD_n['Unnamed: 0'], MinSD_n[format(parallelism)], color=listaCol[i], linewidth=2,label=r'\textit{'+format(parallelism)+  'bits}')    
    i += 1
plt.axhline(y = 0.05, color = 'r', linewidth=4,  linestyle = '--')   
plt.fill_between(MinSD_n['Unnamed: 0'],0.05, 1, alpha=0.2, color='r')     
plt.ylim([-0.05, 1])   
plt.xlim([10, 187112]) 
plt.xscale("log")    
plt.title(r'\textbf{Minimum sphere distance}',fontsize=20)
plt.xlabel(r'\textbf{Number of gates}', fontsize=20)
plt.ylabel(r'\textbf{Minimum sphere distance}', fontsize=20)
leg = plt.legend(loc='upper right', frameon=True, fontsize=15)
leg.get_frame().set_facecolor('white')
plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
plt.savefig("MinSD_nearest.eps", format='eps', bbox_inches='tight')
plt.savefig("MinSD_nearest.png", format='png', bbox_inches='tight')
plt.savefig("MinSD_nearest.pdf", format='pdf', bbox_inches='tight')
plt.close()  
...
leg.get_frame().set_facecolor('white')
plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
plt.savefig("MinSD_nearest_less.eps", format='eps', bbox_inches='tight')
plt.savefig("MinSD_nearest_less.png", format='png', bbox_inches='tight')
plt.savefig("MinSD_nearest_less.pdf", format='pdf', bbox_inches='tight')
plt.close()  



i = 0 
plt.plot(ASD['Unnamed: 0'], ASD['0'], color='red', linewidth=2,label=r'\textit{Emulator}')
for parallelism in parallelisms:
    plt.plot(ASD_n['Unnamed: 0'], ASD_n[format(parallelism)], color=listaCol[i], linewidth=2,label=r'\textit{'+format(parallelism)+  'bits}') 
    i += 1
plt.axhline(y = 0.05, color = 'r', linewidth=4,  linestyle = '--')   
plt.fill_between(ASD_n['Unnamed: 0'],0.05, 1, alpha=0.2, color='r')     
plt.ylim([-0.05, 1])    
plt.xlim([10, 187112]) 
plt.xscale("log")    
plt.title(r'\textbf{Average sphere distance}',fontsize=20)
plt.xlabel(r'\textbf{Number of gates}', fontsize=20)
plt.ylabel(r'\textbf{Average sphere distance}', fontsize=20)
leg = plt.legend(loc='upper right', frameon=True, fontsize=15)
leg.get_frame().set_facecolor('white')
plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
plt.savefig("ASD_nearest.eps", format='eps', bbox_inches='tight')
plt.savefig("ASD_nearest.png", format='png', bbox_inches='tight')
plt.savefig("ASD_nearest.pdf", format='pdf', bbox_inches='tight')
plt.close()
...
leg.get_frame().set_facecolor('white')
plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
plt.savefig("ASD_nearest_less.eps", format='eps', bbox_inches='tight')
plt.savefig("ASD_nearest_less.png", format='png', bbox_inches='tight')
plt.savefig("ASD_nearest_less.pdf", format='pdf', bbox_inches='tight')
plt.close()  
...
plt.plot(MSD['Unnamed: 0'], MSD['0'], color='red', linewidth=2,label=r'\textit{Emulator}')
for parallelism in parallelisms:
    plt.plot(MSD_t['Unnamed: 0'], MSD_t[format(parallelism)], color=listaCol[i], linewidth=2,label=r'\textit{'+format(parallelism)+  'bits}')    
    i += 1
plt.axhline(y = 0.05, color = 'r', linewidth=4,  linestyle = '--')   
plt.fill_between(MSD_t['Unnamed: 0'],0.05, 1, alpha=0.2, color='r')     
plt.ylim([-0.05, 1])   
plt.xlim([10, 187112]) 
plt.xscale("log")    
plt.title(r'\textbf{Maximum sphere distance}',fontsize=20)
...
leg.get_frame().set_facecolor('white')
plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
plt.savefig("MSD_truncation.eps", format='eps', bbox_inches='tight')
plt.savefig("MSD_truncation.png", format='png', bbox_inches='tight')
plt.savefig("MSD_truncation.pdf", format='pdf', bbox_inches='tight')
plt.close()  
...
leg.get_frame().set_facecolor('white')
plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
plt.savefig("MSD_truncation_less.eps", format='eps', bbox_inches='tight')
plt.savefig("MSD_truncation_less.png", format='png', bbox_inches='tight')
plt.savefig("MSD_truncationt_less.pdf", format='pdf', bbox_inches='tight')
plt.close()  
...
plt.plot(MinSD['Unnamed: 0'], MinSD['0'], color='red', linewidth=2,label=r'\textit{Emulator}')
for parallelism in parallelisms:
    plt.plot(MinSD_t['Unnamed: 0'], MinSD_t[format(parallelism)], color=listaCol[i], linewidth=2,label=r'\textit{'+format(parallelism)+  'bits}')    
    i += 1
plt.axhline(y = 0.05, color = 'r', linewidth=4,  linestyle = '--')   
plt.fill_between(MinSD_t['Unnamed: 0'],0.05, 1, alpha=0.2, color='r')     
plt.ylim([-0.05, 1])   
plt.xlim([10, 187112]) 
plt.xscale("log")    
plt.title(r'\textbf{Minimum sphere distance}',fontsize=20)
...
leg.get_frame().set_facecolor('white')
plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
plt.savefig("MinSD_truncation.eps", format='eps', bbox_inches='tight')
plt.savefig("MinSD_truncation.png", format='png', bbox_inches='tight')
plt.savefig("MinSD_truncation.pdf", format='pdf', bbox_inches='tight')
plt.close()  
...
leg.get_frame().set_facecolor('white')
plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
plt.savefig("MinSD_truncation_less.eps", format='eps', bbox_inches='tight')
plt.savefig("MinSD_truncation_less.png", format='png', bbox_inches='tight')
plt.savefig("MinSD_truncation_less.pdf", format='pdf', bbox_inches='tight')
plt.close()  
...
plt.plot(ASD['Unnamed: 0'], ASD['0'], color='red', linewidth=2,label=r'\textit{Emulator}')
for parallelism in parallelisms:
    plt.plot(ASD_t['Unnamed: 0'], ASD_t[format(parallelism)], color=listaCol[i], linewidth=2,label=r'\textit{'+format(parallelism)+  'bits}') 
    i += 1
plt.axhline(y = 0.05, color = 'r', linewidth=4,  linestyle = '--')   
plt.fill_between(ASD_t['Unnamed: 0'],0.05, 1, alpha=0.2, color='r')     
plt.ylim([-0.05, 1])    
plt.xlim([10, 187112]) 
plt.xscale("log")    
plt.title(r'\textbf{Average sphere distance}',fontsize=20)
...
leg.get_frame().set_facecolor('white')
plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
plt.savefig("ASD_truncation.eps", format='eps', bbox_inches='tight')
plt.savefig("ASD_truncation.png", format='png', bbox_inches='tight')
plt.savefig("ASD_truncation.pdf", format='pdf', bbox_inches='tight')
plt.close()
...
leg.get_frame().set_facecolor('white')
plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
plt.savefig("ASD_truncation_less.eps", format='eps', bbox_inches='tight')
plt.savefig("ASD_truncation_less.png", format='png', bbox_inches='tight')
plt.savefig("ASD_truncation_less.pdf", format='pdf', bbox_inches='tight')
plt.close()  
...
plt.plot(MSD['Unnamed: 0'], MSD['0'], color='red', linewidth=2,label=r'\textit{Emulator}')
for parallelism in parallelisms:
    plt.plot(MSD_ne['Unnamed: 0'], MSD_ne[format(parallelism)], color=listaCol[i], linewidth=2,label=r'\textit{'+format(parallelism)+  'bits}')    
    i += 1
plt.axhline(y = 0.05, color = 'r', linewidth=4,  linestyle = '--')   
plt.fill_between(MSD_ne['Unnamed: 0'],0.05, 1, alpha=0.2, color='r')     
plt.ylim([-0.05, 1])   
plt.xlim([10, 187112]) 
plt.xscale("log")    
plt.title(r'\textbf{Maximum sphere distance}',fontsize=20)
...
leg.get_frame().set_facecolor('white')
plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
plt.savefig("MSD_nearest_even.eps", format='eps', bbox_inches='tight')
plt.savefig("MSD_nearest_even.png", format='png', bbox_inches='tight')
plt.savefig("MSD_nearest_even.pdf", format='pdf', bbox_inches='tight')
plt.close()  
...
leg.get_frame().set_facecolor('white')
plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
plt.savefig("MSD_nearest_even_less.eps", format='eps', bbox_inches='tight')
plt.savefig("MSD_nearest_even_less.png", format='png', bbox_inches='tight')
plt.savefig("MSD_nearest_even_less.pdf", format='pdf', bbox_inches='tight')
plt.close()  
...
plt.plot(MinSD['Unnamed: 0'], MinSD['0'], color='red', linewidth=2,label=r'\textit{Emulator}')
for parallelism in parallelisms:
    plt.plot(MinSD_ne['Unnamed: 0'], MinSD_ne[format(parallelism)], color=listaCol[i], linewidth=2,label=r'\textit{'+format(parallelism)+  'bits}')    
    i += 1
plt.axhline(y = 0.05, color = 'r', linewidth=4,  linestyle = '--')   
plt.fill_between(MinSD_ne['Unnamed: 0'],0.05, 1, alpha=0.2, color='r')     
plt.ylim([-0.05, 1])   
plt.xlim([10, 187112]) 
plt.xscale("log")    
plt.title(r'\textbf{Minimum sphere distance}',fontsize=20)
...
leg.get_frame().set_facecolor('white')
plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
plt.savefig("MinSD_nearest_even.eps", format='eps', bbox_inches='tight')
plt.savefig("MinSD_nearest_even.png", format='png', bbox_inches='tight')
plt.savefig("MinSD_nearest_even.pdf", format='pdf', bbox_inches='tight')
plt.close()  
...
leg.get_frame().set_facecolor('white')
plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
plt.savefig("MinSD_nearest_even_less.eps", format='eps', bbox_inches='tight')
plt.savefig("MinSD_nearest_even_less.png", format='png', bbox_inches='tight')
plt.savefig("MinSD_nearest_even_less.pdf", format='pdf', bbox_inches='tight')
plt.close()  
...
plt.plot(ASD['Unnamed: 0'], ASD['0'], color='red', linewidth=2,label=r'\textit{Emulator}')
for parallelism in parallelisms:
    plt.plot(ASD_ne['Unnamed: 0'], ASD_ne[format(parallelism)], color=listaCol[i], linewidth=2,label=r'\textit{'+format(parallelism)+  'bits}') 
    i += 1
plt.axhline(y = 0.05, color = 'r', linewidth=4,  linestyle = '--')   
plt.fill_between(ASD_ne['Unnamed: 0'],0.05, 1, alpha=0.2, color='r')     
plt.ylim([-0.05, 1])    
plt.xlim([10, 187112]) 
plt.xscale("log")    
plt.title(r'\textbf{Average sphere distance}',fontsize=20)
...
leg.get_frame().set_facecolor('white')
plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
plt.savefig("ASD_nearest_even.eps", format='eps', bbox_inches='tight')
plt.savefig("ASD_nearest_even.png", format='png', bbox_inches='tight')
plt.savefig("ASD_nearest_even.pdf", format='pdf', bbox_inches='tight')
plt.close()
...
leg.get_frame().set_facecolor('white')
plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
plt.savefig("ASD_nearest_even_less.eps", format='eps', bbox_inches='tight')
plt.savefig("ASD_nearest_even_less.png", format='png', bbox_inches='tight')
plt.savefig("ASD_nearest_even_less.pdf", format='pdf', bbox_inches='tight')
plt.close()  
...
plt.plot(list(QASMTime['Unnamed: 0']),list(QASMTime['0']), color='tab:orange', linewidth=2,label=r'\textit{QASM Simulator}')
plt.plot(EmulatorTime['Unnamed: 0'], EmulatorTime['0'], color='red', linewidth=2,label=r'\textit{Emulator}')
plt.plot(EmulatorTime_ne['Unnamed: 0'], EmulatorTime_ne[format(20)], color="gold", linewidth=4,label=r'\textit{20 bits nearest even}') 
...
i = 0 
plt.plot(MSD['Unnamed: 0'], MSD['0'], color='red', linewidth=2,label=r'\textit{Emulator}')
plt.plot(MSD_ne['Unnamed: 0'], MSD_ne[format(20)], color="gold", linewidth=2,label=r'\textit{20 bits nearest even}') 
plt.plot(MSD_n['Unnamed: 0'], MSD_n[format(20)], color="forestgreen", linewidth=2,label=r'\textit{20 bits nearest}') 
plt.plot(MSD_t['Unnamed: 0'], MSD_t[format(20)], color="royalblue", linewidth=2,label=r'\textit{20 bits truncation}') 
plt.axhline(y = 0.05, color = 'r', linewidth=4,  linestyle = '--')   
plt.fill_between(MSD_ne['Unnamed: 0'],0.05, 1, alpha=0.2, color='r')     
plt.ylim([-0.05, 1])  
plt.xlim([10, 187112]) 
...
leg.get_frame().set_facecolor('white')
#plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
plt.savefig("MSD_comparison.eps", format='eps', bbox_inches='tight')
plt.savefig("MSD_comparison.png", format='png', bbox_inches='tight')
plt.savefig("MSD_comparison.pdf", format='pdf', bbox_inches='tight')
plt.close()  


i = 0 
plt.plot(MinSD['Unnamed: 0'], MinSD['0'], color='red', linewidth=2,label=r'\textit{Emulator}')
plt.plot(MinSD_ne['Unnamed: 0'], MinSD_ne[format(20)], color="gold", linewidth=2,label=r'\textit{20 bits nearest even}') 
plt.plot(MinSD_n['Unnamed: 0'], MinSD_n[format(20)], color="forestgreen", linewidth=2,label=r'\textit{20 bits nearest}') 
plt.plot(MinSD_t['Unnamed: 0'], MinSD_t[format(20)], color="royalblue", linewidth=2,label=r'\textit{20 bits truncation}') 
plt.axhline(y = 0.05, color = 'r', linewidth=4,  linestyle = '--')   
plt.fill_between(MinSD_ne['Unnamed: 0'],0.05, 1, alpha=0.2, color='r')     
plt.ylim([-0.05, 1])  
plt.xlim([10, 187112]) 
...
leg.get_frame().set_facecolor('white')
#plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
plt.savefig("MinSD_comparison.eps", format='eps', bbox_inches='tight')
plt.savefig("MinSD_comparison.png", format='png', bbox_inches='tight')
plt.savefig("MinSD_comparison.pdf", format='pdf', bbox_inches='tight')
plt.close()  
...
i = 0 
plt.plot(ASD['Unnamed: 0'], ASD['0'], color='red', linewidth=2,label=r'\textit{Emulator}')
plt.plot(ASD_ne['Unnamed: 0'], ASD_ne[format(20)], color="gold", linewidth=2,label=r'\textit{20 bits nearest even}') 
plt.plot(ASD_n['Unnamed: 0'], ASD_n[format(20)], color="forestgreen", linewidth=2,label=r'\textit{20 bits nearest}') 
plt.plot(ASD_t['Unnamed: 0'], ASD_t[format(20)], color="royalblue", linewidth=2,label=r'\textit{20 bits truncation}') 
plt.axhline(y = 0.05, color = 'r', linewidth=4,  linestyle = '--')   
plt.fill_between(ACD_ne['Unnamed: 0'],0.05, 1, alpha=0.2, color='r')     
plt.ylim([-0.05, 1])     
plt.xlim([10, 187112]) 
...
leg.get_frame().set_facecolor('white')
plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
plt.savefig("ASD_comparison.eps", format='eps', bbox_inches='tight')
plt.savefig("ASD_comparison.png", format='png', bbox_inches='tight')
plt.savefig("ASD_comparison.pdf", format='pdf', bbox_inches='tight')
plt.close()
